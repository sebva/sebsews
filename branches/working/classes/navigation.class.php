...
/**
 * This class provides a one line text that we can put on top of each page to show the guest where he is on the website
 * @author seb.vaucher
 * @todo Renice the class to make it more professional
 */
class Navigation
{
	public static function getArray($currentPage)
	{
		$navigation = '<a href="/">'.$nom.'</a> &raquo; ';
		if(isset($news)){
