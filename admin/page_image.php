...
if(!isset($_POST['page'])&&!isset($_FILES['image'])) {
	...
	if(!isset($_POST['imagetodelete'])){?>	
		...
		<p>
		<form action="page_image.php" method="post" enctype="multipart/form-data"><label>Page ciblée : </label><select name="page">
		<?php 
	...
	<?php } else {
		//Prochainement : possibilité de supprimer des images
	}
} else {
...
echo '</p><p><a href="page_index.php">Retour à l\'accueil de l\'administration</a></p>';
require 'footer.php';?>