...
<!--Copyright-->&copy; Copyright <?php echo date(Y)?> - <a href="http://<?php echo $domaine.$repertoire?>"><?php echo $nom?></a>&nbsp;-&nbsp;
					...
					<!--Valid RSS--><a href="http://validator.w3.org/feed/check.cgi?url=http%3A//<?php echo $domaine.$repertoire;echo ($rewrite=='on') ?'/news.xml':'/rss.php';?>"><img src="http://<?php echo $domaine.$repertoire.'/templates/'.$template?>/images/valid-rss.png" alt="Valid RSS" height="20" width="59" /></a>
